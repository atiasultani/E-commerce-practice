...
w-170px
h-170px'>
            <Image src="/productDetail/joy-R1.png" alt='joy-r1' width={80} height={80} />
          </div>
          <div className='
position-absolute
w-170px
h-170px'>
            <Image src="/productDetail/joy-R2.png" alt='joy-r2' width={80} height={80} />
          </div>
          <div className='
position-absolute
w-170px
h-170px'>
            <Image src="/productDetail/joy-R3.png" alt='joy-r3' width={90} height={90} />
          </div>
          <div className='
position-absolute
w-170px
h-170px'>
            <Image src="/productDetail/joy-R4.png" alt='joy-r4' width={90} height={90} />
          </div>
        </div>
        {/* main image */}
        <div className='
...
h-[650px]
mt-20'>
          <Image src="/productDetail/joy-main.png" alt='joy-main' width={446} height={646} />
        </div>

        {/* text details */}
        <div className='w-75 h-80 '>
          <h1 className='font-bold text-[20px]'>Havic HV G-92 Gamepad</h1>
          <div className='flex flex-row'> <Image src="/productDetail/Four Star.png" alt='joy-r4' width={100} height={100} />
            <span>(150 review)</span> | <span className='text-green-500'>in stoke</span>
            </div>
